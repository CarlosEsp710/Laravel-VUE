...
(function(global, factory) {
    ...
    var Carousel = /*#__PURE__*/ (function(_BaseComponent) {
        ...
        _proto._addTouchEventListeners = function _addTouchEventListeners() {
            ...
            if (this._pointerEvent) {
                EventHandler.on(this._element, EVENT_POINTERDOWN, function(
                    event
                ) {
                    return start(event);
                });
                EventHandler.on(this._element, EVENT_POINTERUP, function(
                    event
                ) {
                    return end(event);
                });
                ...
                EventHandler.on(this._element, EVENT_TOUCHSTART, function(
                    event
                ) {
                    return start(event);
                });
                EventHandler.on(this._element, EVENT_TOUCHMOVE, function(
                    event
                ) {
                    return move(event);
                });
    ...
    var Modal = /*#__PURE__*/ (function(_BaseComponent) {
        ...
        _proto._setEscapeEvent = function _setEscapeEvent() {
            ...
            if (this._isShown) {
                EventHandler.on(this._element, EVENT_KEYDOWN_DISMISS, function(
                    event
                ) {
        ...
        _proto._showBackdrop = function _showBackdrop(callback) {
            ...
            if (this._isShown && this._config.backdrop) {
                ...
                EventHandler.on(this._element, EVENT_CLICK_DISMISS, function(
                    event
                ) {
